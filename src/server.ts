...
import { sessionsPath, recoveryDir, snapshotsDir } from "./config.js";
...
const SESSIONS_FILE = sessionsPath();
const RECOVERY_DIR = recoveryDir();
const SNAPSHOTS_DIR = snapshotsDir();
...
async function handleImageUpload(
	...
	const dir = targetDir ?? join(tmpdir(), `interview-${sessionId}`);
